...
while (data_time <= final_date):
     try:
         ...
         my_location = 'https://' + ftp_address + '/archive/geoMeta/6/AQUA/' + str(current_date.tm_year) + '/MYD03_'+ str(current_date.tm_year) + '-' + str(current_date.tm_mon).zfill(2) + '-' + str(current_date.tm_mday).zfill(2) + '.txt'
         print (my_location)
